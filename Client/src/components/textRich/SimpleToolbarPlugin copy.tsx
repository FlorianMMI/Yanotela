...
export default function SimpleToolbarPlugin() {
        ...
        if ($isRangeSelection(selection)) {
            ...
            try {
                ...
                while (currentNode) {
                    ...
                    // Détecter l'alignement depuis les nœuds éléments
                    if (currentNode.getType() === 'paragraph' || currentNode.getType() === 'heading') {
                        try {
    ...
    const handleFontSizeChange = (newSize: string) => {
        setFontSize(newSize);
        // Utiliser la nouvelle fonction qui s'applique uniquement au texte sélectionné
