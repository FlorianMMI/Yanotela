...
export default function FolderHeader({ searchTerm, setSearchTerm, sortBy, setSortBy }: FolderHeaderProps) {
  ...
  return (
    <>
      ...
      {/* Barre de recherche et filtre - Desktop (commenté comme pour NoteHeader) */}
