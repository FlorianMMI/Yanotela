...
export default function TotalNotes({ totalNotes }: TotalNotesProps) {
    ...
    return (
        <div className='flex flex-col items-center justify-center p-6 m-1 bg-white rounded-xl shadow-md w-fit h-fit border border-gray-200 hover:bg-red-100 hover:border-red-500 transition-all cursor-pointer group' onClick={redirectToNotes} title='Voir toutes mes notes'>
