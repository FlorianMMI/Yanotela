...
export default function InputModified({
  ...
  return (
    <div className='self-stretch flex flex-col md:flex-row justify-between items-center gap-2.5  border-b-2 pb-2 border-dashed last:border-b-0 '>
      ...
      {
        type === "email" ?
        <p className="w-1/2 px-3 py-2 border-2 rounded-lg text-clrprincipal bg-gray-200 border-gray-300 cursor-not-allowed">
          {
        ...
        :          
        <div className={`flex gap-4 w-1/2 flex-row`}>
          <input
            type={type}
            name={name}
