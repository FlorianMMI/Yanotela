...
import {
  ...
  setAwarenessUserInfo,
} from "@/collaboration/providers";
import DrawingBoard, {
  DrawingData,
} from "@/components/drawingBoard/drawingBoard";
...
function NoteEditorContent({ params }: NoteEditorProps) {
  ...
  useEffect(() => {
    ...
    const pseudo = (() => {
      ...
      return typeof maybePseudo === "string" && maybePseudo.trim() !== ""
        ? maybePseudo
        : "Anonyme";
    })();
      ...
      {hasError ? (
        ...
        <div className="bg-white p-4 rounded-lg h-full flex items-center justify-center">
          ...
          >
            ...
            <p className="text-textcardNote font-medium">
          ...
          <div ref={containerRef}>
            <LexicalCollaboration>
              <LexicalComposer initialConfig={initialConfig}>
                ...
                {!isReadOnly && (
                  <DrawingInsertPlugin
                    onDrawingInsertRequest={(fn) => {
                      insertDrawingRef.current = fn;
                    }}
                  />
                )}
