...
// Note: Les commentaires sont maintenant gérés via YJS (useYjsComments hook)
// La synchronisation se fait en temps réel via Y.Array partagé entre les clients
// Voir: Client/src/hooks/useYjsComments.ts
